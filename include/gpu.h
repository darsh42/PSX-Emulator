...
union GPUSTAT {
    ...
    struct {
        ...
        enum GENERAL_ENABLE dither: 1;
        enum GENERAL_ENABLE draw_to_display_area: 1;
        enum GENERAL_ENABLE set_mask_when_drawing: 1;
        ...
        enum GENERAL_ENABLE vertical_interlace: 1;
        enum GENERAL_ENABLE display_enable: 1;
        enum GENERAL_ENABLE interrupt_request: 1;
